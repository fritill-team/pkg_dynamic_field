...
scope: 'invariants binding the shared dynamic-field library'
status: draft
created: '2026-08-28'
updated: '2026-08-28'
binds: []
...
the `dynfield` namespace, and an invariant invented at scaffold time is a guess wearing a
